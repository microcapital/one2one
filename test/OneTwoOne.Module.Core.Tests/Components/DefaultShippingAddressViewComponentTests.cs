...
namespace OneTwoOne.Module.Core.Tests.Components
{
    /*
    ...
    public class DefaultShippingAddressViewComponentTests
    {
        ...
        public async Task DefaultAddressViewComponetn_ShouldReturns_CorrectViewName()
        {
            ...
            Assert.Equal("/Modules/OneTwoOne.Module.Core/Views/Components/DefaultShippingAddress.cshtml", view?.ViewName);
        }
        ...
        private DefaultShippingAddressViewComponent MakeMockedDefaultAddressViewComponent(UserAddress address, User user)
        {
            ...
            var contextOptions = new DbContextOptions<OneTwoOneDbContext>();
            var mockContext = new Mock<OneTwoOneDbContext>(contextOptions);
