...
using OneTwoOne.Module.WishList.Areas.WishList.ViewModels;
using OneTwoOne.Module.WishList.Models;
using OneTwoOne.Module.WishList.Services;

namespace OneTwoOne.Module.WishList.Areas.WishList.Controllers
{
    [Area("WishList")]
