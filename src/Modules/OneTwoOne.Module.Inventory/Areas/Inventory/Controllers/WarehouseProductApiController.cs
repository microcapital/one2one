...
using OneTwoOne.Infrastructure.Web.SmartTable;
using OneTwoOne.Module.Catalog.Models;
using OneTwoOne.Module.Core.Extensions;
using OneTwoOne.Module.Inventory.Areas.Inventory.ViewModels;
using OneTwoOne.Module.Inventory.Models;
using OneTwoOne.Module.Inventory.Services;

namespace OneTwoOne.Module.Inventory.Areas.Inventory.Controllers
{
    [Area("Inventory")]
