(function () {
    angular
        .module('oneTwoOne.comment', ['angularUtils.directives.dirPagination'])
        .controller('CommentCtrl', [
            '$scope',
            'commentService',
            function ($scope, commentService) {
                var vm = this;
                vm.comment = { entityId: window.oneTwoOneCommentEntity.entityId, entityTypeId: window.oneTwoOneCommentEntity.entityTypeId };
                vm.comments = [];
                vm.search = '';
                vm.commentCount = 0;
                vm.pagination = {
