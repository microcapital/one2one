...
{
    public class OneTwoOneDbContext : IdentityDbContext<User, Role, long, IdentityUserClaim<long>, UserRole, IdentityUserLogin<long>, IdentityRoleClaim<long>, IdentityUserToken<long>>
    {
        public OneTwoOneDbContext(DbContextOptions options) : base(options)
        {
        }
