...
namespace OneTwoOne.Module.Core.Areas.Core.Controllers
{
    ...
    public class ThemeApiController : Controller
    {
        ...
        public async Task<IActionResult> GetOnlineThemes()
        {
            ...
            var response = await client.GetAsync("http://marketplace.OneTwoOne.com/api/projects/themes");
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var response = await client.GetAsync($"http://marketplace.OneTwoOne.com/api/projects/{name}");
            response.EnsureSuccessStatusCode();
        ...
        public async Task<IActionResult> Install(string name)
        {
            ...
            var client = _httpClientFactory.CreateClient();
            var response = await client.GetAsync($"http://marketplace.OneTwoOne.com/api/projects/{name}/download");
            response.EnsureSuccessStatusCode();
