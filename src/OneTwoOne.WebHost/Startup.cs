...
using OneTwoOne.Module.Localization.Extensions;
using OneTwoOne.Module.Localization.TagHelpers;
...
namespace OneTwoOne.WebHost
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "OneTwoOne API", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "OneTwoOne API V1");
            });
