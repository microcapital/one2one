...
using OneTwoOne.Infrastructure.Web.ModelBinders;
...
namespace OneTwoOne.WebHost.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddCustomizedIdentity(this IServiceCollection services, IConfiguration configuration)
        {
            services
                ...
                .AddRoleStore<OneTwoOneRoleStore>()
                .AddUserStore<OneTwoOneUserStore>()
        ...
        {
            services.AddDbContextPool<OneTwoOneDbContext>(options =>
                options.UseSqlServer(configuration.GetConnectionString("DefaultConnection"),
                    b => b.MigrationsAssembly("OneTwoOne.WebHost")));
            return services;
        }
